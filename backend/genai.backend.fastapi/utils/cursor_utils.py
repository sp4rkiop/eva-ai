...
def encode_cursor(last_id: UUID | str, forward: bool, query: Optional[str] = None) -> str:
    """
...
def decode_cursor(token: Optional[str]) -> Tuple[Optional[UUID], Optional[bool], Optional[str]]:
    """
